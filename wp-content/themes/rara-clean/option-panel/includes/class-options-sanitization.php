...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'rara-clean' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'rara-clean' ),
		'repeat-y'  => __( 'Repeat Vertically', 'rara-clean' ),
		'repeat'    => __( 'Repeat All', 'rara-clean' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'rara-clean' ),
		'top center'    => __( 'Top Center', 'rara-clean' ),
		'top right'     => __( 'Top Right', 'rara-clean' ),
		'center left'   => __( 'Middle Left', 'rara-clean' ),
		'center center' => __( 'Middle Center', 'rara-clean' ),
		'center right'  => __( 'Middle Right', 'rara-clean' ),
		'bottom left'   => __( 'Bottom Left', 'rara-clean' ),
		'bottom center' => __( 'Bottom Center', 'rara-clean' ),
		'bottom right'  => __( 'Bottom Right', 'rara-clean')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'rara-clean' ),
		'fixed'  => __( 'Fixed in Place', 'rara-clean')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'rara-clean' ),
		'italic'      => __( 'Italic', 'rara-clean' ),
		'bold'        => __( 'Bold', 'rara-clean' ),
		'bold italic' => __( 'Bold Italic', 'rara-clean' )
		);
